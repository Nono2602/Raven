; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25547.0 
	...
	TITLE	D:\Mes documents\Git\Projet-IA-Raven\Raven\armory\Projectile_Slug.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG170284 DB	'Slug_MaxForce', 00H
	ORG $+2
$SG170285 DB	'Slug_Mass', 00H
	ORG $+2
$SG170286 DB	'Slug_MaxSpeed', 00H
	ORG $+2
$SG170287 DB	'Slug_Scale', 00H
	ORG $+1
$SG170288 DB	'Slug_Damage', 00H
$SG170289 DB	'Slug_Persistance', 00H
	ORG $+3
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\mes documents\git\projet-ia-raven\raven\armory\projectile_slug.cpp
_TEXT	SEGMENT
$T1 = -140						; size = 16
$T2 = -124						; size = 16
$T3 = -108						; size = 16
...
; Function compile flags: /Odtp /RTCsu
; File d:\mes documents\git\projet-ia-raven\raven\armory\projectile_slug.h
